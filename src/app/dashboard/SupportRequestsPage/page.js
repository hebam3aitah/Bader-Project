        ...
        {totalPages > 0 && (
          <div className="flex justify-center items-center gap-4 p-3 rounded-lg shadow-md bg-white">
            ...
            <div className="flex items-center gap-1">
              <span className="font-medium">صفحة</span>
              <span className="px-3 py-1 rounded-md font-bold bg-[#fa9e1b] text-white">
                {page}
              </span>
              <span className="font-medium">من {totalPages}</span>
            </div>
